...
public class CompositionLayerCollector extends KeyPathAttributeCollector<CompositionLayer> {

    public CompositionLayerCollector() {
        super(CompositionLayer.class);
    }
    ...
    public List<ViewAttribute> collect(
        ...
        attributes.add(new MutablePropertyFloatViewAttribute("TIME_REMAP", 0f) {
            @Override
            protected void mutate(Float value) {
                view.addValueCallback(
                        keyPath,
