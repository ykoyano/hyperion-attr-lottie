...
class AttributeOverlayView extends FrameLayout {
    ...
    private PopupWindow currentDetailWindow;
       ...
       AttributeOverlayView(Context context) {
        ...
        selectionPaint.setColor(ContextCompat.getColor(context, R.color.ha_l_selection));
    ...
    private PopupWindow createDetailWindowForView(View view) {
        ...
        final int width = (int) (getMeasuredWidth() * (5f / 5));
        ...
        popupWindow.setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(context, R.color.ha_l_popup_background)));
