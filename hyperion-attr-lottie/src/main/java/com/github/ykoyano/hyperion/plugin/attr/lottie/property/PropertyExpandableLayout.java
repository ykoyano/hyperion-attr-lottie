...
import com.github.ykoyano.hyperion.plugin.attr.lottie.FloatProperty;

import androidx.interpolator.view.animation.FastOutSlowInInterpolator;
import ykoyano.github.com.hyperion_attr_lottie.R;

import static com.github.ykoyano.hyperion.plugin.attr.lottie.property.PropertyExpandableLayout.State.COLLAPSED;
import static com.github.ykoyano.hyperion.plugin.attr.lottie.property.PropertyExpandableLayout.State.COLLAPSING;
import static com.github.ykoyano.hyperion.plugin.attr.lottie.property.PropertyExpandableLayout.State.EXPANDED;
import static com.github.ykoyano.hyperion.plugin.attr.lottie.property.PropertyExpandableLayout.State.EXPANDING;

/**
 * Expanding layout implementation from https://github.com/cachapa/ExpandableLayout
 */
public class PropertyExpandableLayout extends FrameLayout {
    ...
    public static final FloatProperty<PropertyExpandableLayout> EXPANSION =
            new FloatProperty<PropertyExpandableLayout>("Expansion") {
                @Override
                public void setValue(PropertyExpandableLayout object, float value) {
                    object.setExpansion(value);
                }

                @Override
                public Float get(PropertyExpandableLayout object) {
    ...
    public PropertyExpandableLayout(Context context) {
        this(context, null);
    }

    public PropertyExpandableLayout(Context context, AttributeSet attrs) {
        super(context, attrs);

        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ha_l_ExpandableLayout);
            duration = a.getInt(R.styleable.ha_l_ExpandableLayout_ha_l_duration, DEFAULT_DURATION);
            expansion = a.getBoolean(R.styleable.ha_l_ExpandableLayout_ha_l_expanded, false) ? 1 : 0;
            orientation = a.getInt(R.styleable.ha_l_ExpandableLayout_android_orientation, VERTICAL);
            parallax = a.getFloat(R.styleable.ha_l_ExpandableLayout_ha_l_parallax, 1);
            a.recycle();
