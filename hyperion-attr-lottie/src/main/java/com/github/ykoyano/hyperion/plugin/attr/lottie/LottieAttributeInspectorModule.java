...
class LottieAttributeInspectorModule extends PluginModule
        implements View.OnClickListener, OnOverlayViewChangedListener, OnMenuStateChangedListener {

    private static final String OVERLAY_TAG = "lottie_attribute_inspector_overlay";
    ...
    public View createPluginView(@NonNull LayoutInflater layoutInflater, @NonNull ViewGroup parent) {
        View view = layoutInflater.inflate(R.layout.item_plugin, parent, false);
